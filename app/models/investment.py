...
class Investment(Base):
    ...
    sold_price_per_fraction = Column(Float, nullable=True)
    sold_value_total = Column(Float, nullable=False, default=0.0)
    sold_profit_total = Column(Float, nullable=False, default=0.0)
